...
class LR35902ResetBitTests {
    ...
    @Test
    fun `RES 0, (HL)`() {
        memory.set(cpu.HL, 0xFFu)

        memory.set(1u, 0x86u)

        cpu.step()
        assertEquals(UByte.invertedMasks[0], memory.get(cpu.HL))
    }
    ...
    fun `RES 1, (HL)`() {
        ...
        cpu.step()
        assertEquals(UByte.invertedMasks[1], memory.get(cpu.HL))
    }
    ...
    fun `RES 2, (HL)`() {
        ...
        cpu.step()
        assertEquals(UByte.invertedMasks[2], memory.get(cpu.HL))
    }
    ...
    fun `RES 3, (HL)`() {
        ...
        cpu.step()
        assertEquals(UByte.invertedMasks[3], memory.get(cpu.HL))
    }
    ...
    fun `RES 4, (HL)`() {
        ...
        cpu.step()
        assertEquals(UByte.invertedMasks[4], memory.get(cpu.HL))
    }
    ...
    fun `RES 5, (HL)`() {
        ...
        cpu.step()
        assertEquals(UByte.invertedMasks[5], memory.get(cpu.HL))
    }
    ...
    fun `RES 6, (HL)`() {
        ...
        cpu.step()
        assertEquals(UByte.invertedMasks[6], memory.get(cpu.HL))
    }
    ...
    fun `RES 7, (HL)`() {
        ...
        cpu.step()
        assertEquals(UByte.invertedMasks[7], memory.get(cpu.HL))
    }
}
