...
class LR35902SetBitTests {
    ...
    fun `SET 0, (HL)`() {
        ...
        cpu.step()
        assertEquals(UByte.masks[0], memory.get(cpu.HL))
    }
    ...
    fun `SET 1, (HL)`() {
        ...
        cpu.step()
        assertEquals(UByte.masks[1], memory.get(cpu.HL))
    }
    ...
    fun `SET 2, (HL)`() {
        ...
        cpu.step()
        assertEquals(UByte.masks[2], memory.get(cpu.HL))
    }
    ...
    fun `SET 3, (HL)`() {
        ...
        cpu.step()
        assertEquals(UByte.masks[3], memory.get(cpu.HL))
    }
    ...
    fun `SET 4, (HL)`() {
        ...
        cpu.step()
        assertEquals(UByte.masks[4], memory.get(cpu.HL))
    }
    ...
    fun `SET 5, (HL)`() {
        ...
        cpu.step()
        assertEquals(UByte.masks[5], memory.get(cpu.HL))
    }
    ...
    fun `SET 6, (HL)`() {
        ...
        cpu.step()
        assertEquals(UByte.masks[6], memory.get(cpu.HL))
    }
    ...
    fun `SET 7, (HL)`() {
        ...
        cpu.step()
        assertEquals(UByte.masks[7], memory.get(cpu.HL))
    }
}
